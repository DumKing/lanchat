...
assert.match(appVue, /watch\(activeMessages,[\s\S]{0,220}if \(messagePaneFollowingLatest\.value\)[\s\S]{0,120}scrollActiveChatToBottom/, "仅在用户位于最新消息时自动滚动，阅读历史时不应被强制跳回底部");
