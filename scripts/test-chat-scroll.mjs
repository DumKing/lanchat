...
assert.match(appVue, /watch\(activeMessages,[\s\S]{0,100}scrollActiveChatToBottom/, "消息变化后应滚动到最新消息");
assert.match(appVue, /watch\(\(\) => activeConversationId\.value,[\s\S]{0,100}scrollActiveChatToBottom/, "切换聊天会话后应滚动到最新消息");
