...
assert.match(workflow, /RELEASE_NOTES_PATH/, "企业微信通知应定位本次发布的 Markdown 说明文件");
assert.match(workflow, /RELEASE_NOTES=\$\(cat "\$\{RELEASE_NOTES_PATH\}"\)/, "企业微信通知正文应读取本次发布的 Markdown 说明");
