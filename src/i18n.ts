...
const messages = {
  "zh-CN": {
    ...
    "vision.runtime.embedding_dimensions": "特征维度",
    ...
    "vision.people.coverage": "当前模型特征：人脸 {face} · 人体 {body}",
  ...
  "en-US": {
    ...
    "vision.runtime.embedding_dimensions": "Embedding dimensions",
    ...
    "vision.people.coverage": "Active model features: face {face} · body {body}",
